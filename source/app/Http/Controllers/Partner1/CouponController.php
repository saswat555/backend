...
class CouponController extends Controller
{
    ...
    public function AddNewcoupon(Request $request)
    {
        ...
        $coupon_image->move('coupon/images/'.$date.'/', $fileName);
        $coupon_image = 'coupon/images/'.$date.'/'.$fileName;


        $insert = DB::table('coupon')
                  ->insert(['category_id'=>$category_name,'coupon_name'=>$coupon_name,'coupon_discount'=>$discount,'coupon_code'=>$startingg.$coupon_code,'begin_date'=>$begin_date,'coupon_image'=>$coupon_image,'end_date'=>$end_date,'description'=>$coupon_description,'cart_value'=>$cart_value,'created_at'=>$created_at]);
    ...
    return redirect()->back()->withErrors('this function is disabled for demo.');
        ...
        $update = DB::table('coupon')
                 ->where('coupon_id', $coupon_id)
                 ->update(['category_id'=>$category_name,'coupon_name'=>$coupon_name,'coupon_discount'=>$coupon_discount,'coupon_code'=>$startingg.$coupon_code,'begin_date'=>$begin_date,'coupon_image'=>$coupon_image,'end_date'=>$end_date,'description'=>$coupon_description,'cart_value'=>$cart_value,'updated_at'=>$updated_at]);
