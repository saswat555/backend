                     ...
                     <div class="content-sticky-footer">
                        <div class="card text-center" style="margin-top: 12px;">
                           ...
                           <div class="card-body credit_body">
                              ...
                              <h3 style="margin-top: -14px;">211 credits</h3>
                              <a href="recharge_wallet.php" class="btn btn-primary btn-sm credit_a">buy Credits</a>
                           </div>
                                                   ...
                                                   <div class="card-body">
                                                      <div class="media">
                                                         <a href="lead_preview.php" class="media-body">
                                                            <p><span>25 feb, 01:46</span><span style="float: right;color: #CE0115;">Lead bought</span></p>
                                                            <h5 style="margin-top: 6px;">Rajnish G. <span style="float: right;">200 Credits</span></h5>
                                                            <p style="margin-top: 8px;"><span style="color: blue;">View Lead</span> <span style="float: right;">remaining Credits: 211</span></p>
                                                         </a>
                                                      </div>
                                                   </div>
                                                </div>
