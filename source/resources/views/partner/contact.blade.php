                           ...
                           <div class="col-12 mar_gin10">
                                 ...
                                 <div class="card-footer pt-0">
                                    <div class="media">
                                       <div class="form-group bank_but">
                                          <input type="text" id="exampleInputEmail1" placeholder="Enter Your Name" class="bank_input" aria-describedby="emailHelp">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="card contact_card">
                                 ...
                                 <div class="card-footer pt-0">
                                    <div class="media">
                                       <div class="form-group bank_but">
                                          <input type="email" id="exampleInputEmail1" placeholder="Enter Your Email Id" class="bank_input" aria-describedby="emailHelp">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="card contact_card">
                                 ...
                                 <div class="card-footer pt-0">
                                    <div class="media">
                                       <div class="form-group bank_but" >
                                          <input type="number" id="exampleInputEmail1" placeholder="Enter Your Phone Number" class="bank_input" aria-describedby="emailHelp">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="card contact_card" >
                                 ...
                                 <div class="card-footer pt-0">
                                    <div class="media">
                                       <div class="form-group bank_but">
                                          <input type="text" id="exampleInputEmail1" placeholder="Enter Your Profession" class="bank_input" aria-describedby="emailHelp">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="card contact_card">
                                 ...
                                 <div class="card-footer pt-0">
                                    <div class="media">
                                       <div class="form-group bank_but">
                                          <textarea placeholder="Go ahead, we're listening..." id="exampleInputEmail1" class="bank_input" rows="3">
                                          </textarea>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <center><button class="btn send_but_ton"><i class="icon material-icons" >check</i> Send Message</button></center>
                           </div>
                        </div>
                        <br>
                     </div>
