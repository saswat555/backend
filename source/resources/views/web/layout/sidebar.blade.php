<div class="sidebar sidebar-left">
   <div class="profile-link">
      <a href="#" class="media">
         <div class="w-auto h-100">
            <figure class="avatar avatar-40"><img src="{{url($partner->partner_image)}}" alt=""> </figure>
         </div>
         <div class="media-body">
            <h5>{{$partner->partner_name}} <span class="status-online bg-success"></span></h5>
            <p>India</p>
         </div>
      </a>
   </div>
   <nav class="navbar">
      <ul class="navbar-nav">
         <li class="nav-item">
            <a href="{{route('index')}}" class="sidebar-close">
         ...
         <li class="nav-item">
            <a href="{{route('credithistory')}}" class="sidebar-close" >
               <div class="item-title">
         ...
         <li class="nav-item">
            <a href="{{route('bankdetail')}}" class="sidebar-close">
               <div class="item-title">
         ...
         <li class="nav-item">
            <a href="{{route('term')}}" class="sidebar-close">
               <div class="item-title">
         ...
         <li class="nav-item">
            <a href="{{route('partnerenquiry')}}" class="sidebar-close">
               <div class="item-title">
