         ...
         <div class="page">
            ...
            <div class="page-content">
               <nav class="tabber tabber-bottom">
                  <a href="{{route('buylead',[$booking->booking_id])}}">
                    <center><button class="btn respond_but">Respond ({{$booking->coins}} credits)</button></center>
                  </a>
               </nav>
                           ...
                           <div class="col-12">
                              ...
                              <div class="card-body" style="margin-top: -24px;">
                                 <div class="media">
                                    <a href="#" class="media-body">
                                       <p>Date & Time</p>
                                       <h5 style="font-size: 14px;margin-top: 2px;">{{$booking->confirmed_on}}</h5>
                                    </a>
                                 </div>
                              </div>
                           </div>
