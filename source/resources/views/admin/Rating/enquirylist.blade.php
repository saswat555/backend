                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
							<button type="button"  style="width: 10px; padding-left: 11px;" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$rewards->enq_id}}"><i class="fa fa-trash"></i></button>
							</td>
