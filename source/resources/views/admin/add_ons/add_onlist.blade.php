                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('editadd_ons',$add->add_on_id)}}" class="btn btn-info"  style="width: 10px;padding-left: 9px;" style="color: #fff;"><i class="fa fa-edit" style="width: 10px;"></i></a>
							<button type="button"  style="width: 10px; padding-left: 11px;" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$add->add_on_id}}"><i class="fa fa-trash"></i></button>
							</td>
